!function(){
    ...
    console.log("customerly snippet ")
    ...
    u[o]=function(t){u[r]=t||{};
        ...
        (i.head || i.documentElement).appendChild(e);
        var n=i.getElementsByTagName("script")[0];
        n.parentNode.insertBefore(e,n)};

    u.o.forEach(function(t){u[t]=u.u(t)})


}();

var d = document.getElementById('customerly-snippet');
const projectId = d.getAttribute("data-project-id");
